...
$cf_channel_sections = array(
	...
	'social' => array(
		...
		'items' => array(
			...
			array(
				...
				'title' => __( 'Instagram', 'collective-finity' ),
			...
			array(
				'icon'  => 'fa-brands fa-youtube',
				'title' => __( 'YouTube (Channel 2)', 'collective-finity' ),
				'desc'  => __( 'Full releases, visualizers, and session videos.', 'collective-finity' ),
				'url'   => collective_finity_get_social_url( 'social_youtube_2' ),
				'cta'   => __( 'Subscribe', 'collective-finity' ),
			),
		),
	),
	'streaming' => array(
		...
		'items' => array(
			...
			array(
				'icon'  => 'fa-brands fa-spotify',
				'title' => __( 'Spotify (Artist 2)', 'collective-finity' ),
				'desc'  => __( 'Official playlists and new releases.', 'collective-finity' ),
				'url'   => collective_finity_get_social_url( 'social_spotify_2' ),
				'cta'   => __( 'Listen', 'collective-finity' ),
			),
		),
	),
